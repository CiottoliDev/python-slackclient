...
class Block(JsonObject):
    ...
    def __init__(self, *, _type: str, block_id: Optional[str] = None):
        self.type = _type
...
class DividerBlock(Block):
    def __init__(self, *, block_id: Optional[str] = None):
        ...
        """
        super().__init__(_type="divider", block_id=block_id)
...
class ImageBlock(Block):
    ...
    def __init__(
        ...
        """
        super().__init__(_type="image", block_id=block_id)
    ...
    def __init__(
        ...
        Args:
            ...
            block_id: ID to be used for this block - autogenerated if left blank.
                Cannot exceed 255 characters.
        """
        super().__init__(_type="actions", block_id=block_id)
    ...
    def __init__(
        ...
        Args:
            ...
            block_id: ID to be used for this block - autogenerated if left blank.
                Cannot exceed 255 characters.
        """
        super().__init__(_type="context", block_id=block_id)
        self.elements = elements
...
class InputBlock(Block):
    ...
    def label_length(self):
        return len(self.label.text) <= self.label_max_length
...
class FileBlock(Block):
    ...
    def __init__(
        ...
        """
        super().__init__(_type="file", block_id=block_id)
